...
router.delete(
  "/stream-engine/processors/:processor",
  processorsResource.delete
);

router.get("/stream-engine/participants", participantsResource.getList);
router.get(
  "/stream-engine/participants/:participant",
