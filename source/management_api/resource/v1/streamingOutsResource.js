...
exports.getList = function (req, res, next) {
  log.debug(
    "Representing streaming-outs for room ",
    req.params.room
  );
...
exports.add = function (req, res, next) {
  ...
  var sub_req = {
    ...
    connection: {
      protocol:
        ...
        guessProtocol(
          req.body.url
        ) /*FIXME: req.body.protocol should be mandatorily specified*/,
      url: req.body.url,
    },
  ...
  if (sub_req.connection.protocol === "hls") {
    sub_req.connection.parameters = req.body.parameters || {
      method: "PUT",
      hlsTime: 2,
      hlsListSize: 5,
    };
  ...
  requestHandler.addServerSideSubscription(
    req.params.room,
    sub_req,
    function (result, err) {
      if (result === "error") {
...
exports.patch = function (req, res, next) {
  var sub_id = req.params.id,
    cmds = req.body;
  requestHandler.controlSubscription(
    req.params.room,
    sub_id,
    cmds,
    function (result) {
...
exports.delete = function (req, res, next) {
  var sub_id = req.params.id;
  requestHandler.deleteSubscription(
    req.params.room,
    sub_id,
    "streaming",
    function (result) {
