...
bool AcmmFrameMixer::addInput(const std::string& group, const std::string& inStream, const infraframe::FrameFormat format, infraframe::FrameSource* source)
{
    boost::unique_lock<boost::shared_mutex> lock(m_mutex);
    boost::shared_ptr<AcmmGroup> acmmGroup;
...
bool AcmmFrameMixer::addOutput(const std::string& group, const std::string& outStream, const infraframe::FrameFormat format, infraframe::FrameDestination* destination)
{
    boost::unique_lock<boost::shared_mutex> lock(m_mutex);
    boost::shared_ptr<AcmmGroup> acmmGroup;
