...
public:
    ...
    bool addInput(const std::string& endpoint, const std::string& inStreamId, const std::string& codec, infraframe::FrameSource* source);
    ...
    bool addOutput(const std::string& endpoint, const std::string& outStreamId, const std::string& codec, infraframe::FrameDestination* dest);
