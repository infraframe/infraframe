...
public:
    ...
    virtual bool addInput(const std::string& group, const std::string& inStream, const infraframe::FrameFormat format, infraframe::FrameSource* source) = 0;
    ...
    virtual bool addOutput(const std::string& group, const std::string& outStream, const infraframe::FrameFormat format, infraframe::FrameDestination* destination) = 0;
