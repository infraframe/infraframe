...
var RpcRequest = function (rpcChannel) {
  ...
  that.handleCascadingEvents = function (controller, event) {
    return rpcChannel.makeRPC(
      controller,
      "handleCascadingEvents",
      [event],
      4000
    );
  };
  ...
  that.onCascadingConnected = function (
    ...
    return rpcChannel.makeRPC(
      controller,
      "onCascadingConnected",
      [bridgeId, sessionId, streamId, clientId],
      4000
    );
  };
  ...
  that.subscribe = function (
    ...
    return rpcChannel.makeRPC(
      controller,
      "subscribe",
      [participantId, subscriptionId, Options],
      4000
    );
  };
