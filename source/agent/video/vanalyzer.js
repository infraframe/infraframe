...
const log = require("../logger").logger.getLogger("VAnalyzerJS");
...
function VAnalyzer(rpcClient, clusterIP, VideoTranscoder, router) {
  var that = {},
    engine,
    controller,
    drawing_text_tmr,
  ...
  that.initialize = function (motionFactor, ctrlr, callback) {
    ...
    log.debug(
      "Video transcoding engine init OK, supported_codecs:",
      supported_codecs
    );
