...
class SctpPeer : public infraframe::RawTransportListener {
public:
    SctpPeer()
        : m_recvCount(0)
    {
        m_transport.reset(new infraframe::SctpTransport(this));
        m_transport->open();
    }
...
private:
    boost::shared_ptr<infraframe::SctpTransport> m_transport;
