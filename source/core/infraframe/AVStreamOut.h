...
class MediaFrame {
public:
    MediaFrame(const infraframe::Frame& frame, int64_t timeStamp = 0)
...
public:
    ...
    void pushFrame(const infraframe::Frame& frame)
    {
...
class AVStreamOut : public infraframe::FrameDestination, public EventRegistry {
    DECLARE_LOGGER();
...
private:
    ...
    boost::shared_ptr<infraframe::MediaFrame> m_videoKeyFrame;
