...
{
    if (codec == "vp8") {
        return infraframe::FRAME_FORMAT_VP8;
    } else if (codec == "h264") {
        return infraframe::FRAME_FORMAT_H264;
    } else if (codec == "vp9") {
        return infraframe::FRAME_FORMAT_VP9;
    } else if (codec == "h265") {
        return infraframe::FRAME_FORMAT_H265;
    } else if (codec == "av1") {
        return infraframe::FRAME_FORMAT_AV1;
    } else if (codec == "pcm_48000_2" || codec == "pcm_raw") {
        return infraframe::FRAME_FORMAT_PCM_48000_2;
    } else if (codec == "pcmu") {
        return infraframe::FRAME_FORMAT_PCMU;
    } else if (codec == "pcma") {
        return infraframe::FRAME_FORMAT_PCMA;
    } else if (codec == "isac_16000") {
        return infraframe::FRAME_FORMAT_ISAC16;
    } else if (codec == "isac_32000") {
        return infraframe::FRAME_FORMAT_ISAC32;
    } else if (codec == "ilbc") {
        return infraframe::FRAME_FORMAT_ILBC;
    } else if (codec == "g722_16000_1") {
        return infraframe::FRAME_FORMAT_G722_16000_1;
    } else if (codec == "g722_16000_2") {
        return infraframe::FRAME_FORMAT_G722_16000_2;
    } else if (codec == "opus_48000_2") {
        return infraframe::FRAME_FORMAT_OPUS;
    } else if (codec.compare(0, 3, "aac") == 0) {
        if (codec == "aac_48000_2")
            return infraframe::FRAME_FORMAT_AAC_48000_2;
        else
            return infraframe::FRAME_FORMAT_AAC;
    } else if (codec.compare(0, 3, "ac3") == 0) {
        return infraframe::FRAME_FORMAT_AC3;
    } else if (codec.compare(0, 10, "nellymoser") == 0) {
        return infraframe::FRAME_FORMAT_NELLYMOSER;
    } else {
        return infraframe::FRAME_FORMAT_UNKNOWN;
    }
}
...
class VideoFrameProcessor : public FrameSource, public FrameDestination {
public:
