...
var mediavideoparametersframerate = [
  6, 6, 6, 6, 6, 6, 6, 12, 15, 24, 30, 48, 60,
];
...
var recordtest = function (
  ...
  var recordjson =
    '{"container":"mp4","media":{"audio":{"from":"142020205294123520","format":{"codec":"opus","sampleRate":48000,"channelNum":2}},"video":{"from":"142020205294123520","format":{"codec":"h264","profile":"CB"},"parameters":{"resolution":{"width":640,"height":480},"framerate":15,"bitrate":"x0.2","keyFrameInterval":2}}}}';
  ...
  recordjs.media.video.parameters.keyFrameInterval =
    mediavideoparameterskeyFrameInterval;
...
fs.writeFile(filename, recordarrayjson, (err) => {
  if (err) throw err;
  console.log("case ok");
});
