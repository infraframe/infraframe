let createRoomPars = [
  {
    name: "WEBRTC",
    options: {
      notifying: { streamChange: true, participantActivities: true },
      transcoding: {
        video: {
          parameters: {
      ...
      mediaOut: {
        video: {
          parameters: {
            keyFrameInterval: [1, 2, 5, 30, 100],
            bitrate: [500, 1000],
            framerate: [5, 15, 24, 30, 48, 60],
            resolution: ["x1/2", "x3/4", "x2/3"],
          },
          format: [
            { codec: "h264", profile: "CB" },
            { codec: "h264", profile: "B" },
            { codec: "h264", profile: "M" },
            { codec: "h264", profile: "H" },
            { codec: "h265" },
            { codec: "vp8" },
            { codec: "vp9" },
          ],
        ...
        audio: [
          ...
          { codec: "acc", sampleRate: 48000, channelNum: 2 },
          { codec: "ac3" },
          { codec: "ilbc" },
        ],
      },
      ...
      participantLimit: -1,
      inputLimit: -1,
      sip: { sipServer: "", username: "", password: "" },
    },
  },
  {
    name: "WEBRTC",
    options: {
      notifying: { streamChange: false, participantActivities: false },
      transcoding: {
        video: {
          parameters: {
      ...
      views: [
        {
          ...
          audio: {
            vad: false,
            format: { codec: "g722", sampleRate: 16000, channelNum: 1 },
          },
          label: "common",
        },
      ],
      roles: [
        {
          subscribe: { audio: false, video: false },
      ...
      views: [
        {
          ...
          audio: {
            vad: true,
            format: { codec: "acc", sampleRate: 48000, channelNum: 2 },
          },
          label: "common",
        },
      ],
...
let updateRecordingPars = [
  {
    updateRecordPar: [
      { op: "replace", path: "/media/audio/from", value: "{{roomId}}-common" },
      { op: "replace", path: "/media/video/from", value: "{{roomId}}-common" },
      { op: "replace", path: "/media/video/parameters/bitrate", value: "x0.2" },
      {
        op: "replace",
        path: "/media/video/parameters/resolution",
        value: { width: 640, height: 480 },
      },
      { op: "replace", path: "/media/video/parameters/framerate", value: 6 },
      {
        op: "replace",
  ...
  },
  {
    updateRecordPar: [
      ...
      { op: "replace", path: "/media/video/parameters/framerate", value: 12 },
      {
        op: "replace",
        path: "/media/video/parameters/keyFrameInterval",
        value: 1,
  ...
  },
  {
    updateRecordPar: [
      ...
      { op: "replace", path: "/media/video/parameters/framerate", value: 15 },
      {
        op: "replace",
        path: "/media/video/parameters/keyFrameInterval",
        value: 1,
  ...
  },
  {
    updateRecordPar: [
      ...
      { op: "replace", path: "/media/video/parameters/framerate", value: 24 },
      {
        op: "replace",
        path: "/media/video/parameters/keyFrameInterval",
        value: 1,
  ...
  },
  {
    updateRecordPar: [
      ...
      { op: "replace", path: "/media/video/parameters/framerate", value: 30 },
      {
        op: "replace",
        path: "/media/video/parameters/keyFrameInterval",
        value: 1,
  ...
  },
  {
    updateRecordPar: [
      ...
      { op: "replace", path: "/media/video/parameters/framerate", value: 48 },
      {
        op: "replace",
        path: "/media/video/parameters/keyFrameInterval",
        value: 1,
  ...
  },
  {
    updateRecordPar: [
      ...
      { op: "replace", path: "/media/video/parameters/framerate", value: 60 },
      {
        op: "replace",
        path: "/media/video/parameters/keyFrameInterval",
        value: 1,
